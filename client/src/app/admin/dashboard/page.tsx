...
const sidebarItems = [
  ...
  { href: "/admin/products", icon: Package, label: "Manage Products", active: false },
                  ...
                  <CardContent>
                    <ResponsiveContainer width="100%" height={300}>
                      <AreaChart data={revenueData}>
                        ...
                        <Tooltip />
                        <Legend />
                        <Area yAxisId="left" type="monotone" dataKey="revenue" stroke="#dc2626" fill="#dc2626" fillOpacity={0.3} name="Revenue ($)" />
